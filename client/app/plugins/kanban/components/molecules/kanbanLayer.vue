<template lang="pug">
    li.layer
        ...
        ul.kanban-list(data-type="layer", :data-id="layer.id"
            ...
            kanban.top-level-item(v-for="kanban in layer.kanbans", :parent="layer", :kanban="kanban", :key="kanban.id", :isTopLevel="true", :isDisplayTag="true", :removable="layer.removable"
