...
<style lang="scss" scoped>
    @font-face {
        font-family: 'icomoon';
        src:  url('../treelist/fonts/icomoon.eot?ui1hbx');
        src:  url('../treelist/fonts/icomoon.eot?ui1hbx#iefix') format('embedded-opentype'),
        url('../treelist/fonts/icomoon.ttf?ui1hbx') format('truetype'),
        url('../treelist/fonts/icomoon.woff?ui1hbx') format('woff'),
        url('../treelist/fonts/icomoon.svg?ui1hbx#icomoon') format('svg');
        font-weight: normal;
        font-style: normal;
    }
    .media {
